...
The process involves blending geospatial analysis with creative data visualization. Here’s a high-level look at the technical pipeline:
    ...
    **Data Acquisition:**
    I utilized NetCDF files for temperature and precipitation, processed via xarray and rioxarray for efficient spatial handling.
    
    **Smoothing & Resampling**:
    To reduce noise and ensure the maps were readable, I applied a Gaussian filter for subtle smoothing.
    
    **Quantile Classification:** 
    I broke both datasets into 3-class terciles (low, medium, high). This ensures the colors represent relative values specific to the region's climate.
    
    **The Color Matrix:**
    I mapped these classes to a $3 x 3$ grid.
    ...
    **Masking:** 
    Using geopandas, I clipped the global data to the specific boundaries of the African continent and the Kenyan border for a clean finish.
